...
const SearchFilters = () => {
    ...
    return (
        <div
            ...
            className="h-[48px] lg:h-[64] flex flex-row items-center justify-between border rounded-full shadow-[rgba(17,17,26,0.05)_0px_1px_0px,rgba(17,17,26,0.1)_0px_0px_8px]"
        >
